...
@Schema(
  ...
  "debtorId": "123e4567-e89b-12d3-a456-426614174001"
}"""
)
data class PaymentCreateRequest(
    ...
    @Schema(description = "Currency code (ISO 4217). Valid values: USD, EUR, GBP, etc.", example = "USD", required = true)
    val currency: String,
    ...
    @Schema(description = "Payment status. Valid values: RECEIVED, PROCESSING, COMPLETED, FAILED", example = "RECEIVED", required = true)
    val status: String,

    @Schema(description = "Creditor ID (optional). Use an existing creditor ID from the database.", example = "123e4567-e89b-12d3-a456-426614174000")
    val creditorId: UUID? = null,

    @Schema(description = "Debtor ID (optional). Use an existing debtor ID from the database.", example = "123e4567-e89b-12d3-a456-426614174001")
